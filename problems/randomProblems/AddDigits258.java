...
public class AddDigits258 {
    public static void main(String[] args) {
        ...
        System.out.println(addDigits(0)); // expected 0
        System.out.println(addDigits(38)); // expected 2
    }
     ...
     * 
     * 
     * This explanation/algorithm skips the whole "add digits until there is only 1 remaining", so the description of this problem seems pretty misleading to me since it makes you think the solution will be something unrelated to the optimal one. 
     * I guess the point of Leetcode is to learn all of these tricks though.
     * 
     * **/
    public int addDigits_Optimal(int num) {
        if(num == 0) return 0;
